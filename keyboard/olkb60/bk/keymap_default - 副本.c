...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    KEYMAP_ANSI(
         ...
         FN9, BTN1, MS_U, BTN2, WH_U, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, PAUS, TRNS, \
        TRNS, MS_L, MS_D, MS_R, WH_D, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, \
        TRNS, TRNS,  FN4,  FN3,  FN5, TRNS, TRNS, SLCK, TRNS,  FN7,  FN6,  FN8, TRNS, VOLU,  FN0, \
        TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, PSCR,  FN2, TRNS, TRNS, TRNS, MUTE, VOLD, TRNS  ),
    /* 2: Num Layer */
    KEYMAP_ANSI(
